...
class AdminServiceTest {
    ...
    void listAllUsersWithLoans_returnsMappedUsers() {
        ...
        LoanLentRepository loanLentRepository = mock(LoanLentRepository.class);
        LoanBorrowedRepository loanBorrowedRepository = mock(LoanBorrowedRepository.class);
        ...
        AdminService svc = new AdminService(userRepository, loanLentRepository, loanBorrowedRepository);
    ...
    void resetUserPassword_hashesAndSaves() throws Exception {
        ...
        assertTrue(new BCryptPasswordEncoder().matches("newpass123", saved.getPasswordHash()));
    }
